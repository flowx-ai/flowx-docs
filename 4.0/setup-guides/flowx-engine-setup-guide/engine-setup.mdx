...
This section contains environment variables that control the settings for data partitioning and archiving, including the archiving scheduler. These settings determine how data is segmented, retained, and managed, including compression and batch processing. 
