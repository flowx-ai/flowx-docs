...
- **Database**: Primary storage for the engine. See [Database Configuration](#database-configuration).
...
To configure Prometheus metrics export for the FlowX.AI Engine, the following environment variables are required:
...
<Card title ="Process instance partitioning and archiving" href ="./process-instance-data-archiving" icon ="link">
</Card>
