...
- Make sure you use the appropriate distribution and version:
...
### Step 5: Deploy and Helm charts

- Deploy Helm charts for OpenTelemetry components, Grafana, Loki, Prometheus, and Tempo.
