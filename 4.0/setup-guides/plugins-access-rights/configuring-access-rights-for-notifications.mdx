---
title: Notifications plugin access rights
description: Granular access rights can be configured for restricting access to the Notification plugin component.
icon: lock-open
---
...
2. **Manage-notifications** -  for configuring access to REST endpoints for managing and sending notifications
