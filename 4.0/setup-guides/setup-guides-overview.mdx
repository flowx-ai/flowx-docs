...
The following FlowX services use Jaeger tracing:

1. [**scheduler-core**](/4.0/docs/platform-deep-dive/core-extensions/scheduler)
2. [**customer-management-plugin**](/4.0/docs/platform-deep-dive/plugins/custom-plugins/customer-management/customer-management-overview)
3. [**document-plugin**](/4.0/docs/platform-deep-dive/plugins/custom-plugins/documents-plugin/documents-plugin-overview)
4. [**notification-plugin**](/4.0/docs/platform-deep-dive/plugins/custom-plugins/notifications-plugin/notifications-plugin-overview)
5. [**flowx-engine**](/4.0/docs/platform-deep-dive/core-components/flowx-engine)
