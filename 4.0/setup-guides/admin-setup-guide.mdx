...
description: The admin part manages process-related entities and provides the REST API used by the FlowX Designer. The processes defined here will be handled by the FlowX Engine.
icon: terminal
---

The FlowX.AI Admin microservice uses most of the same resources as the **FlowX.AI Engine**.

### Database - Postgres / Oracle

The backend microservice connects to the same Postgres / Oracle database as FlowX.AI Engine.
