...
The plugin can use the [Redis component](../../4.0/docs/platform-overview/frameworks-and-standards/event-driven-architecture-frameworks/intro-to-redis) already deployed for the **FlowX Engine**.
