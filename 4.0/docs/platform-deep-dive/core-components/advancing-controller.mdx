...
description: The Advancing Controller is a support service for the Process Engine that enhances the efficiency of advancing operations. It facilitates equal distribution and redistribution of the workload during scale-up and scale-down scenarios.
---
...
<Info>
It is important to ensure that both the Process Engine and the Advancing Controller microservices are up and running concurrently for optimal performance.
</Info>
