...
### Searching for substitution tags

The search functionality allows you to quickly find specific substitution tags within your solution. Here's how to use it effectively:

1. Locate the **Search by** field at the top of the substitution tags list
2. You can search using the following criteria:
   * Key - find tags by their unique identifier
   * Value - search through the tag values across all languages
3. The search is case-insensitive and supports partial matches
4. Results are updated in real-time as you type
5. Clear the search field to return to the full list of substitution tags

<Info>
The search functionality automatically filters the displayed results, making it easier to manage large sets of substitution tags.
</Info>
