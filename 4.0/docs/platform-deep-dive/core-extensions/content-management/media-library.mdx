---
title: Media library
description: The media library serves as a centralized hub for managing and organizing various types of media files, including images, GIFs, and more. It encompasses all the files that have been uploaded to the **processes**, providing a convenient location to view, organize, and upload new media files.
---
...
The Media Library provides a robust search functionality to help you quickly find your assets:

### Search by key
* Enter the full key or a part of it in the search box
* The search is case-insensitive
* Results update in real-time as you type

### Search filters
You can refine your search using multiple criteria:
* **Format type** - filter assets by their format (PNG, JPEG, SVG, etc.)
* **Size range** - find assets within specific size ranges
* **Date modified** - filter assets by their last modification date

### Search tips
* Use clear, descriptive keys when uploading assets to make them easier to find later
* The search functionality supports partial matches, so you can find assets even with incomplete key names
