...
Add a [**Send Message Task** (kafka send event)](/4.0/docs/building-blocks/node/message-send-received-task-node) and configure it to send content requests to the FlowX.AI Engine.
