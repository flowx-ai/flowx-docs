...
* **Before releasing Theming feature**: you'd configure styles for each component in **UI Designer**. 
* **With Theming**: Use Theme Overrides in UI Designer to adjust styles or props for specific UI elements based on the platform.
