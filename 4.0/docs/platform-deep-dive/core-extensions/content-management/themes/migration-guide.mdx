...
<Info>
**Theme overrides** in **UI Designer** are applied to the UI template itself, rather than to specific themes. This means that when switching the view to another theme, the overrides persist and apply to the new theme as well.
</Info>
...
<Info>
There are some changes that were brought together with the Themes feature to the UI components in **4.0** release that might impact your previous UI configuration.
</Info>
...
Within the context of the theming feature, you can now directly apply the paddings that were previously configured in theme JSONs within the theme settings. Check the paddings you had before and apply them now in the Themes section.
...
**Themes → Componentss → Layout Elements**
