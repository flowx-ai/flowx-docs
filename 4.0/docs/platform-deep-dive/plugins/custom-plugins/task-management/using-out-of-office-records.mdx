...
## Searching out-of-office records

To search through out-of-office records, you can use the search bar located at the top of the records list. The search functionality allows you to:

1. Search by user information:
   * First name
   * Last name
   * Username
2. Search by date range:
   * Use the date picker to filter records within a specific time period
3. Search by status:
...
<Info>
The search is performed in real-time as you type, and results are updated automatically. You can combine multiple search criteria to narrow down your results.
</Info>
