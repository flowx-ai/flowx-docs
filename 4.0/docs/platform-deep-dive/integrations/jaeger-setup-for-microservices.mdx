---
title: Jaeger setup for microservices
description: The scope of this document is to present some basic information on how to include Jaeger tracing into a Java based project.
---
