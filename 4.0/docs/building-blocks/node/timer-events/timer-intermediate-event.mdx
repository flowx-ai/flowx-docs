---
title: "Timer Intermediate Event (interrupting)"
description: "A Timer Intermediate Event (interrupting) is an event that is triggered based on a specified time duration or date. It is placed within the flow of a process and serves as a point of interruption and continuation."
keywords: ["timer event", "intermediate event", "BPMN timer", "process flow timer", "ISO 8601", "timer configuration", "process scheduling", "timer duration", "timer date", "process interruption"]
---
