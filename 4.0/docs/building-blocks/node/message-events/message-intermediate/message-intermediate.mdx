...
<Card title ="Message Throw Intermediate Event" href ="/4.x/docs/building-blocks/node/message-events/message-intermediate/message-throw-intermediate-event" icon ="link">
</Card>
...
<Card title ="Message Catch Intermediate Event" href ="/4.x/docs/building-blocks/node/message-events/message-intermediate/message-catch-intermediate-event" icon ="link">
</Card>