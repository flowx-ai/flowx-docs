...
To configure the UI of the footers and headers you must use containers as root UI elements. You have two styles options:

![]()

* **Static** - it will not be displayed along with scroll
* **Sticky** - after sticky property si set to true, the container keeps its position at scroll
