...
<Info>
You can hide containers on different platforms by using Overrides in the Settings tab. For instance, you can set a container to appear on all platforms, or create an override to hide it on mobile but show it on web.
