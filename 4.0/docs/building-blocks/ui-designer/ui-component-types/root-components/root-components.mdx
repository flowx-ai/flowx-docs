...
1. [**Form**](./4.0/docs/building-blocks/ui-designer/ui-component-types/form-elements/) - Used to group and align form field elements (inputs, radios, checkboxes, etc.).

<Info>
For more information about the form elements, please refer to the[<u>**Form elements**</u>](./4.0/docs/building-blocks/ui-designer/ui-component-types/form-elements/) section.
</Info>
