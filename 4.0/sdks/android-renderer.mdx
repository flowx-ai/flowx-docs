...
dependencies {
    ...
    implementation("ai.flowx.android:android-sdk:3.0.0")
    ...
}
```
...
| `setAccessTokenProvider`     | Updates the access token provider (i.e. a functional interface) inside the renderer                                | `fun setAccessTokenProvider(provider: FlowxSdkApi.Companion.AccessTokenProvider)`                                                                                                     |
