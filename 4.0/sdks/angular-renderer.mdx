...
<Info>
The library uses Angular version **@angular\~16**, **npm v8.1.2** and **node v18.18.0**.
</Info>
...
Component theming is done through the FlowX CMS using the [**Theme Management**](../docs/platform-deep-dive/core-extensions/content-management/themes/) feature in FlowX Designer.
...
<flx-process-renderer
  [apiUrl]="baseApiUrl"
  [processApiPath]="processApiPath"a
  [authToken]="authToken"
  [themeId]="themeId"
