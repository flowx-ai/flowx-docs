...
* [Redis](#redis)
* [NGINX](#nginx)
* [EFK (Elasticsearch, Fluentd, Kibana)](#efk-kibana-fluentd-elastic-search)
* [S3 (MinIO)](#s3-minio)
...
| 4.2.0                     | MongoDB                  | 7.0.6                     |
| 4.2.0                     | Redis                    | 7.2.4                     |
| 4.2.0                     | NGINX Ingress Controller | 1.2.0                     |
| 4.2.0                     | Elasticsearch            | 7.17                      |
| 4.2.0                     | minio                    | 2024-02-26T09-33-48Z      |
