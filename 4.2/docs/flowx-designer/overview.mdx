...
* you can also check the installed versions against the suggested versions for each [**FLOWX Component**](/4.0/docs/platform-deep-dive/integrations/jaeger-setup-for-microservices)
