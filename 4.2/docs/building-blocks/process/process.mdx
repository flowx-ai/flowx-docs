...
<Frame>
![](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/release40/process_designer_41.png)
</Frame>

When you encounter a process definition menu, it encompasses the following essential elements:

<AccordionGroup>
  <Accordion title="Process definition name">
  ...
  <Accordion title="Version - main (Work In Progress)">
  ...
  <Accordion title="Branching Icon">
  ...
  <Accordion title="Submit Changes">
  ...
  <Accordion title="Start">
    <p>This option signifies the ability to initiate the execution of a process definition, setting it in motion.</p>
  </Accordion>
  <Accordion title="Lock Icon">
