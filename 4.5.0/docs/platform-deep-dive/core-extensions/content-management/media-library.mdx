...
The Media Library provides a robust search functionality to help you quickly locate your assets. Here's what you need to know about searching:

### Search by key
* You can search for assets using their complete key or a partial key (substring)
* The search is case-insensitive for your convenience
* Search results update in real-time as you type

### Search tips
* Use descriptive keys when uploading assets to make them easier to find later
* The search bar is located at the top of the Media Library interface
* Clear the search field to return to the full asset list
* Search results maintain all asset information including previews, format, size, and editing details
