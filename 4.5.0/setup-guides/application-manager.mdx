...
* **Resource Export**  
  * **Topic:** `${kafka.topic.naming.prefix}application${separator2}version${separator}export${kafka.topic.naming.suffix}`
  * **Purpose:** Topic for exporting application resources.
  
* **Resource Import**  
  * **Topic:** `${kafka.topic.naming.prefix}application${separator2}version${separator}import${kafka.topic.naming.suffix}`
  * **Purpose:** Topic for importing application resources.

#### Build Resource Topics

* **Build Export**  
  * **Topic:** `${kafka.topic.naming.prefix}build${separator}export${kafka.topic.naming.suffix}`
  * **Purpose:** Topic for exporting build resources.
  
* **Build Import**  
  * **Topic:** `${kafka.topic.naming.prefix}build${separator}import${kafka.topic.naming.suffix}`
  * **Purpose:** Topic for importing build resources.

#### Process Topics

* **Start for Event**  
  * **Topic:** `${kafka.topic.naming.prefix}core${separator}trigger${separator}start${separator2}for${separator2}event${separator}process${kafka.topic.naming.suffix}`
  * **Purpose:** Topic for starting processes based on external events.
  
* **Scheduled Timer Events**  
  * **Set Timer Schedule**  
    * **Topic:** `${kafka.topic.naming.prefix}core${separator}trigger${separator}set${separator}timer${separator2}event${separator2}schedule${kafka.topic.naming.suffix}`
    * **Purpose:** Topic for setting scheduled timer events.
  * **Stop Timer Schedule**  
    * **Topic:** `${kafka.topic.naming.prefix}core${separator}trigger${separator}stop${separator}timer${separator2}event${separator2}schedule${kafka.topic.naming.suffix}`
    * **Purpose:** Topic for stopping scheduled timer events.

#### Audit Topics

* **Audit Output**  
  * **Topic:** `${kafka.topic.naming.prefix}core${separator}trigger${separator}save${separator}audit${kafka.topic.naming.suffix}`
  * **Purpose:** Topic for sending audit-related events.
