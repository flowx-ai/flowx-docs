...
To configure a required EntraID setup, in this guide we will covere the following steps:
...
## Other apps registration

These steps outline the registration and configuration of additional applications required for FlowX.AI functionality.

* Flowx-Admin app
* Flowx-Process-Engine app 
* Flowx-Integration-Designer app
* Flowx-Task-Management-Plugin app
* Flowx-Scheduler-Core app
...
<Info>
This is done using Microsoft Graph CLI.
</Info>

To add custom attributes to your FlowX.AI applications, follow these steps using the Microsoft Graph CLI (mgc).
