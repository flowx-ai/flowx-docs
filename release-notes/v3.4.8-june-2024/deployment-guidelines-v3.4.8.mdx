...
Therefore, before starting the new version of the process-engine, we recommend manually executing the setup SQL commands from Liquibase, as they may take more time. After setup, all existing information will go into the initial partition.
</Check>
...
[Process instance data archiving & partitionig details](../../3.x/setup-guides/flowx-engine-setup-guide/process-instance-data-archiving)

[Process instance data archiving & partitioning configuration](../../3.x/setup-guides/flowx-engine-setup-guide/engine-setup#partitioning-and-archiving)
