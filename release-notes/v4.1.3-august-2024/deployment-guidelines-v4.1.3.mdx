---
title: Deployment guidelines v4.1.3
---
...
<Warning>
After upgrading to the 4.1.3 FlowX.AI release, you can import old process definitions into the new platform only from versions 4.0/4.1.x.
...
| **customer-management-plugin** | 2.0.3        | 2.0.3    | 2.0.3  | 2.0.2  | 1.0.6  | 0.2.8      | 0.2.8     | 0.2.8     | 0.2.8     | 0.2.8   | 0.2.8  | 0.2.8  | 0.2.6  | 0.2.4   | 0.2.3  | 0.2.3  | 0.2.1  |
...
| **iOS renderer**               | 3.0.7        | 3.0.7    | 3.0.7  | 3.0.7  | 3.0.0  | 2.3.0      | 2.3.0     | 2.3.0     | 2.3.0     | 2.3.0   | 2.3.0  | 2.3.0  | 2.3.0  | 2.1.0   | 2.0.1  | 2.0.0  | 2.0.0  |
| **Android renderer**           | 3.0.4        | 3.0.4    | 3.0.4  | 3.0.4  | 3.0.0  | 2.1.4      | 2.1.4     | 2.1.4     | 2.1.4     | 2.1.4   | 2.1.4  | 2.1.4  | 2.1.4  | 2.0.1   | 2.0.1  | 2.0.1  | 2.0.1  |
