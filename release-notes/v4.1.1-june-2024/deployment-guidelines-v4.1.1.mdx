...
<Warning>
After updating to the 4.1.1 FlowX.AI release, you can import old process definitions into the new platform only if they are from versions 4.0 & 4.1.1.
...
### Process instance partitioning & archiving
...
<Card title="Environment variables" href="../../4.0/setup-guides/flowx-engine-setup-guide/engine-setup#configuring-data-partitioning-and-archiving">
</Card>
