...
[Process instance data archiving & partitionig details](../../4.0/setup-guides/flowx-engine-setup-guide/engine-setup#partitioning-and-archiving)

[Process instance data archiving & partitioning configuration](../../4.0/setup-guides/flowx-engine-setup-guide/process-instance-data-archiving)