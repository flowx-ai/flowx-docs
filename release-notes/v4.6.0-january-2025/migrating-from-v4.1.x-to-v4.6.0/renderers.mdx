...
!!!TODO!!! update to latest 4.6 versions
...
- OLD: `FlxProcessModule.forRoot({...})`
- NEW: `FlxProcessModule.withConfig({...})`


#### Import path updates

- `@flowx/ui-sdk`  → `@flowx/angular-sdk` (or `@flowx/core-sdk` in a few cases)
- `@flowx/ui-theme` → `@flowx/angular-theme`
- `@flowx/ui-toolkit` → `@flowx/angular-ui-toolkit`

- OLD: `import {FlxLocalizationModule} from '@flowx/ui-sdk';` 
- NEW: `import {FlxLocalizePipe} from '@flowx/angular-sdk';`

You can also remove the `FlxLocalizationModule` from any `imports` arrays in modules, and import the `FlxLocalizePipe` instead

- OLD: `import {FlxTaskManagementModule} from '@flowx/ui-sdk';`
- NEW: `import {FlxTasksManagementComponent} from '@flowx/angular-sdk';`

- OLD: `import {ClientStoreInterface} from '@flowx/ui-sdk';`
- NEW: `import {ClientStoreInterface} from '@flowx/core-sdk';`
