---
title: Deployment guidelines v3.4.1
---
...
* As of **FLOWX.AI 3.0**, the `paperflow-web-components` library will be deprecated. Instead, the new components can be found in `@flowx/ui-toolkit`.
:::
