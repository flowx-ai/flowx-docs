...
```
<Info>
If you do not change to the new envinroment variable, make sure that in the actual configuration you will remove the protocol/schema, it is no longer needed: for example, instead of 'http://localhost:9200' here you will have `http://localhost:9200`.
</Info>
