...
<Warning>
As of **FlowX.AI** next release (v4.1.0), the `paperflow-web-components` is deprecated, removing the dependencies. Instead, the new components can be found in `@flowx/ui-toolkit`.
</Warning>
