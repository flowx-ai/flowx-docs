...
- **Process Designer**: Automatically dismiss navigation generated by secondary tokens upon reaching stop process events, ensuring a smooth return to the main process flow
