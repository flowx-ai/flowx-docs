...
This feature supports version control at the application level, allowing users to create and manage multiple versions and builds. Applications also facilitate resource sharing through dependencies, enabling the reuse of processes and configurations across projects. These enhancements make it easier to maintain project integrity, deploy updates seamlessly, and ensure consistency across environments.


<Info>
With the introduction of the **Application** concepy you might notice some significant changes in the FlowX.AI Designer structure, and also new concepts that Application is briging to the table:

* Config vs build
* Global resources vs application resources
</Info>
