---
title: Deployment changes for v4.5.0
description: This document outlines the configuration and infrastructure changes introduced from v4.1.x to v4.5.0 for deploying the FlowX.AI platform.
---
...
<Card title="CMS setup guide" href="../../../4.5.0/setup-guides/cms-setup" icon ="file">
</Card>
