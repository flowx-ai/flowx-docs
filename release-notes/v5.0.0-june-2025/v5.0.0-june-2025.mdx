  ...
  <Tab title="What's New">
    ...
    <Card title="FlowX Database" icon="server" iconType="duotone">
        ...
        <Tabs>
          <Tab title="Overview">
            <Frame>
            ![](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/470/flowx_db_overview.png)
            </Frame>
          ...
          <Tab title="UI Integration">
            ...
            ![](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/470/flowx_db_datasource.png)
            </Frame>
      ...
      <div className="flex justify-between items-center">
        <a href="/5.x/docs/platform-deep-dive/core-extensions/flowx-database" className="inline-flex items-center gap-1 text-indigo-600 dark:text-indigo-400 font-medium hover:text-indigo-800 dark:hover:text-indigo-300 transition-colors">
