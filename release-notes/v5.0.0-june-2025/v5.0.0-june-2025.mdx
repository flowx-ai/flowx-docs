...
This documentation covers FlowX.AI 5.0 Technology Preview. 
...
<Card title="Workspaces" icon="building-columns" iconType="duotone">
  <Tabs>
    <Tab title="Overview">
      <Frame>
      ![Workspaces multi-tenant architecture](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/5.x/workspaces_overview.png)
      </Frame>
      
      FlowX 5.0 introduces Workspaces, enabling organizations to manage multiple business lines, verticals, or countries within a single FlowX instance while maintaining complete data isolation.
    </Tab>
    
    <Tab title="Key Features">
      <CardGroup cols={2}>
        <Card title="Multi-Tenant Architecture" icon="building-columns">
          Logical separation of business contexts with shared infrastructure for cost optimization
        </Card>
  ...
  <div className="flex justify-between items-center">
    <a href="../../5.0-tech-preview/docs/projects/workspaces" className="inline-flex items-center gap-1 text-indigo-600 dark:text-indigo-400 font-medium hover:text-indigo-800 dark:hover:text-indigo-300 transition-colors">
  ...
  <Tabs>
    <Tab title="DevOps Engineer 🔧">
      ...
      **Key Changes:**
      ...
      - **User Storage**: Users now stored in FlowX database
      - **Default Workspace**: Existing customers get automatic migration to default workspace
    ...
    <Tab title="Process Configurator ⚙️">
      <Tip>
        **New Login Flow**: After authentication, select your workspace before accessing FlowX Designer. Once inside a workspace, everything works as before.
      </Tip>
      ...
      **What Stays the Same:**
      ...
      - All existing FlowX Designer features
    </Tab>
    ...
    <Card title="Project Data Model (PDM)" icon="database" iconType="duotone">
      ...
      <div className="flex justify-between items-center">
        <a href="../../5.0-tech-preview/docs/building-blocks/process/project-data-model" className="inline-flex items-center gap-1 text-indigo-600 dark:text-indigo-400 font-medium hover:text-indigo-800 dark:hover:text-indigo-300 transition-colors">
...
<video
  ...
  playsInline
  controls
  src="https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/5.x/flowx_db_demo.mp4"
></video>
</Frame>
      ...
      <div className="flex justify-between items-center">
        <a href="../../5.0-tech-preview/docs/platform-deep-dive/integrations/flowx-database" className="inline-flex items-center gap-1 text-indigo-600 dark:text-indigo-400 font-medium hover:text-indigo-800 dark:hover:text-indigo-300 transition-colors">
    ...
    <Card title="Multi Select UI Component" icon="list-check" iconType="duotone">
      ...
      <div className="flex justify-between items-center">
        <a href="../../5.0-tech-preview/docs/building-blocks/ui-designer/ui-component-types/form-elements/multi-select" className="inline-flex items-center gap-1 text-indigo-600 dark:text-indigo-400 font-medium hover:text-indigo-800 dark:hover:text-indigo-300 transition-colors">
    ...
    <Card title="Library-to-Library Dependencies" icon="list" iconType="duotone">
      <Tabs>
        ...
        <div className="flex justify-between items-center">
          <a href="../../5.0-tech-preview/docs/projects/managing-applications/dependencies" className="inline-flex items-center gap-1 text-indigo-600 dark:text-indigo-400 font-medium hover:text-indigo-800 dark:hover:text-indigo-300 transition-colors">
    ...
    <Accordion title="👥 What This Means for Your Role">
      <Tabs>
        <Tab title="DevOps Engineer 🔧">
<Info>
        **Full Backwards Compatibility**: FlowX 5.0 maintains full backwards compatibility with existing project-to-library dependencies from FlowX 4.x. All existing dependencies will continue to work without modification.
      </Info>
