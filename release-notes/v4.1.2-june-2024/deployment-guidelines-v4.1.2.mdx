...
<Warning>
After upgrading to the 4.1.2 FlowX.AI release, you can import old process definitions into the new platform only if they are from versions 4.0/4.1 & 4.1.1.
...
| **designer**                   | **4.17.1-1** | 4.17.1 | 4.17.1 | 4.0.1  | 3.35.18-5  | 3.35.18-3 | 3.35.18-2 | 3.35.18-1 | 3.35.18 | 3.35.9 | 3.35.6 | 3.33.2 | 3.28.11 | 3.21.1 | 3.15.1 | 3.2.1  |
| **@flowx/ui-sdk**              | **4.17.1-1** | 4.17.1 | 4.17.1 | 4.0.1  | 3.35.18-5  | 3.35.18-3 | 3.35.18-2 | 3.35.18-1 | 3.35.18 | 3.35.9 | 3.35.6 | 3.33.2 | 3.28.11 | 3.21.1 | 3.15.1 | 3.2.1  |
| **@flowx/ui-toolkit**          | **4.17.1-1** | 4.17.1 | 4.17.1 | 4.0.1  | 3.35.18-5  | 3.35.18-3 | 3.35.18-2 | 3.35.18-1 | 3.35.18 | 3.35.9 | 3.35.6 | 3.33.2 | 3.28.11 | 3.21.1 | 3.15.1 | 3.2.1  |
| **@flowx/ui-theme**            | **4.17.1-1** | 4.17.1 | 4.17.1 | 4.0.1  | 3.35.18-5  | 3.35.18-3 | 3.35.18-2 | 3.35.18-1 | 3.35.18 | 3.35.9 | 3.35.6 | 3.33.2 | 3.28.11 | 3.21.1 | 3.15.1 | 3.2.1  |
...
| **customer-management-plugin** | 2.0.3        | 2.0.3  | 2.0.2  | 1.0.6  | 0.2.8      | 0.2.8     | 0.2.8     | 0.2.8     | 0.2.8   | 0.2.8  | 0.2.8  | 0.2.6  | 0.2.4   | 0.2.3  | 0.2.3  | 0.2.1  |
...
| **iOS renderer**               | 3.0.7        | 3.0.7  | 3.0.7  | 3.0.0  | 2.3.0      | 2.3.0     | 2.3.0     | 2.3.0     | 2.3.0   | 2.3.0  | 2.3.0  | 2.3.0  | 2.1.0   | 2.0.1  | 2.0.0  | 2.0.0  |
| **Android renderer**           | 3.0.4        | 3.0.4  | 3.0.4  | 3.0.0  | 2.1.4      | 2.1.4     | 2.1.4     | 2.1.4     | 2.1.4   | 2.1.4  | 2.1.4  | 2.1.4  | 2.0.1   | 2.0.1  | 2.0.1  | 2.0.1  |
...
| ------------------------- | ----------------- | -------------------------------------- |
| 4.1.2                     | Keycloak          | 22.0.x                                 |
| 4.1.2                     | Kafka             | 3.2.3                                  |
| 4.1.2                     | PostgreSQL        | 16.2.0                                 |
| 4.1.2                     | MongoDB           | 7.0.6                                  |
| 4.1.2                     | Redis             | 7.2.4                                  |
| 4.1.2                     | Elasticsearch     | 7.17                                   |
| 4.1.2                     | OracleDB          | 19.8.0.0.0                             |
| 4.1.2                     | Angular (Web SDK) | 16.0.0                                 |
