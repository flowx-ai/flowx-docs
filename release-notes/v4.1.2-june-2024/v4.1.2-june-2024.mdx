...
- Improved PDF viewer locale setting based on renderer language configuration. Now, the PDF viewer will display content according to the chosen language setting, enhancing user experience with localized content.
