...
Now, for processes migrated from **v3.4.x** to acheive the previous styling (with "raised prop" or "border") you can either set up from Themes or by using **Theme Overrides** for **Card** element in **UI Designer**:
