...
description: This guide outlines changes in process and UI configuration from the previous version to 4.0 version.
---
...
<Warning>
Please be aware that with the relocation of `processInstanceId`, `parentProcessInstanceId`, and `parentProcessInstanceUuid` from paramValues to a separate location within process instance data, additional configuration is required. It’s recommended to review and update any affected business rules accordingly.
</Warning>
