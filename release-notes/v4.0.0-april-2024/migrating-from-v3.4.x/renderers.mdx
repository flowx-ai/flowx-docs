...
<Card title="Theming setup" href="/sdks/angular-renderer#theming" icon="link">
</Card>
...
<Card title ="More details here" href="/4.0/sdks/angular-renderer#authorization" icon ="link">
</Card>
