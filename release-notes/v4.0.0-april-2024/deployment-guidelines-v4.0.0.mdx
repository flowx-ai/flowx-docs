...
To streamline logging and enhance readability, you can now disable these health endpoint calls by adjusting the following environment variables to the 'INFO' level during each microservice deployment.
