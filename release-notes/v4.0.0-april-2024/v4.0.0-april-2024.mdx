...
Updated Helm charts to improve health probes default settings:

- Updated platform health annotations to use 'flowx.ai/health' as the annotation name with the value set to 'true', ensuring effective monitoring within the 'flowx' namespace
- Enhanced health probes to default to the Actuator endpoint, ensuring accurate platform health monitoring. 
