...
<Info>
**Important:** These changes are backward compatible and require no action from users. All clients have been automatically updated to use the new endpoint structure.
</Info>
