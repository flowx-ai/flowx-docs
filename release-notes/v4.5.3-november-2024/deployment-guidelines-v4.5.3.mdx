---
title: Deployment guidelines v4.5.3
---
...
| Component                    | 4.5.3      | 4.5.2  | 4.5.1  | 4.5.0  | 4.1.4    | 4.1.3    | 4.1.2    | 4.1.1  | 4.1    | 4.0       | 3.4.7      | 3.4.6     | 3.4.5     | 3.4.4     | 3.4.3   | 3.4.2  | 3.4.1  | 3.4.0  | 3.3.0   | 3.2.0  | 3.1.0  | 3.0.0  |
| ---------------------------- | ---------- | ------ | ------ | ------ | -------- | -------- | -------- | ------ | ------ | --------- | ---------- | --------- | --------- | --------- | ------- | ------ | ------ | ------ | ------- | ------ | ------ | ------ |
| **process-engine**           | **7.4.3**  | 7.4.1  | 7.4.1  | 7.3.5  | 6.1.6    | 6.1.4    | 6.1.3    | 6.1.2  | 6.0.3  | 5.10.3    | 4.3.5-2v11 | 4.3.5-2v6 | 4.3.5-2v2 | 4.3.5-2v1 | 4.3.5   | 4.3.2  | 4.3.1  | 4.1.0  | 3.6.0   | 2.2.1  | 2.1.2  | 2.0.7  |
| **admin**                    | **6.2.7**  | 6.2.5  | 6.2.2  | 6.1.11 | 5.1.6    | 5.1.5    | 5.1.4    | 5.1.3  | 5.0.9  | 4.6.10    | 3.3.19-6   | 3.3.19-4  | 3.3.19-3  | 3.3.19-1  | 3.3.19  | 3.3.10 | 3.3.7  | 3.1.1  | 2.5.2   | 2.2.2  | 2.1.3  | 2.0.8  |
| **designer**                 | **5.22.9** | 5.21.4 | 5.18.0 | 5.9.8  | 4.17.1-5 | 4.17.1-3 | 4.17.1-2 | 4.17.1 | 4.17.1 | 4.0.1     | 3.35.18-5  | 3.35.18-3 | 3.35.18-2 | 3.35.18-1 | 3.35.18 | 3.35.9 | 3.35.6 | 3.33.2 | 3.28.11 | 3.21.1 | 3.15.1 | 3.2.1  |
| **@flowx/ui-sdk**            | **5.22.9** | 5.21.4 | 5.18.0 | 5.9.8  | 4.17.1-5 | 4.17.1-3 | 4.17.1-2 | 4.17.1 | 4.17.1 | 4.0.1     | 3.35.18-5  | 3.35.18-3 | 3.35.18-2 | 3.35.18-1 | 3.35.18 | 3.35.9 | 3.35.6 | 3.33.2 | 3.28.11 | 3.21.1 | 3.15.1 | 3.2.1  |
| **@flowx/ui-toolkit**        | **5.22.9** | 5.21.4 | 5.18.0 | 5.9.8  | 4.17.1-5 | 4.17.1-3 | 4.17.1-2 | 4.17.1 | 4.17.1 | 4.0.1     | 3.35.18-5  | 3.35.18-3 | 3.35.18-2 | 3.35.18-1 | 3.35.18 | 3.35.9 | 3.35.6 | 3.33.2 | 3.28.11 | 3.21.1 | 3.15.1 | 3.2.1  |
| **@flowx/ui-theme**          | **5.22.9** | 5.21.4 | 5.18.0 | 5.9.8  | 4.17.1-5 | 4.17.1-3 | 4.17.1-2 | 4.17.1 | 4.17.1 | 4.0.1     | 3.35.18-5  | 3.35.18-3 | 3.35.18-2 | 3.35.18-1 | 3.35.18 | 3.35.9 | 3.35.6 | 3.33.2 | 3.28.11 | 3.21.1 | 3.15.1 | 3.2.1  |
| **@flowx/react-sdk**         | **5.22.9** | 5.21.4 | 5.18.0 | 5.9.8  | -        | -        | -        | -      | -      | -         | -          | -         | -         | -         | -       | -      | -      | -      | -       | -      | -      |        |
| **@flowx/react-theme**       | **5.22.9** | 5.21.4 | 5.18.0 | 5.9.8  | -        | -        | -        | -      | -      | -         | -          | -         | -         | -         | -       | -      | -      | -      | -       | -      | -      |        |
| **@flowx/react-ui-toolkit**  | **5.22.9** | 5.21.4 | 5.18.0 | 5.9.8  | -        | -        | -        | -      | -      | -         | -          | -         | -         | -         | -       | -      | -      | -      | -       | -      | -      |        |
| **@flowx/core-sdk**          | **5.22.9** | 5.21.4 | 5.18.0 | 5.9.8  | -        | -        | -        | -      | -      | -         | -          | -         | -         | -         | -       | -      | -      | -      | -       | -      | -      |        |
| **@flowx/core-theme**        | **5.22.9** | 5.21.4 | 5.18.0 | 5.9.8  | -        | -        | -        | -      | -      | -         | -          | -         | -         | -         | -       | -      | -      | -      | -       | -      | -      |        |
...
| **cms-core**                 | **4.2.1**  | 4.1.15 | 4.1.10 | 4.1.6  | 3.0.3    | 3.0.2    | 3.0.2    | 3.0.2  | 3.0.1  | 2.2.5     | 1.3.9      | 1.3.9     | 1.3.9     | 1.3.9     | 1.3.9   | 1.3.9  | 1.3.9  | 1.3.6  | 1.3.0   | 1.2.0  | 1.0.3  | 1.0.2  |
...
| **notification-plugin**      | **5.1.1**  | 5.1.0  | 5.0.4  | 5.0.4  | 4.0.4    | 4.0.3    | 4.0.3    | 4.0.3  | 4.0.1  | 3.0.6     | 2.0.9      | 2.0.9     | 2.0.9     | 2.0.9     | 2.0.9   | 2.0.8  | 2.0.8  | 2.0.5  | 2.0.4   | 2.0.4  | 2.0.3  | 2.0.1  |
| **document-plugin**          | **5.1.1**  | 5.1.0  | 5.0.4  | 5.0.4  | 4.0.3    | 4.0.2    | 4.0.2    | 4.0.2  | 4.0.0  | 3.0.6     | 2.0.10-1   | 2.0.10    | 2.0.10    | 2.0.10    | 2.0.10  | 2.0.8  | 2.0.8  | 2.0.6  | 2.0.4   | 2.0.3  | 2.0.3  | 2.0.2  |
...
| **task-management-plugin**   | **6.0.9**  | 6.0.8  | 6.0.5  | 6.0.1  | 5.0.5    | 5.0.4    | 5.0.4    | 5.0.4  | 5.0.2  | 4.0.5     | 3.0.3      | 3.0.3     | 3.0.3     | 3.0.3     | 3.0.3   | 3.0.3  | 3.0.3  | 3.0.0  | 2.1.2   | 1.0.4  | 1.0.4  | 1.0.1  |
...
| **audit-core**               | 5.0.3      | 5.0.3  | 5.0.3  | 5.0.3  | 4.0.5    | 4.0.4    | 4.0.4    | 4.0.4  | 4.0.3  | 3.1.4     | 2.2.0      | 2.2.0     | 2.2.0     | 2.2.0     | 2.2.0   | 2.1.3  | 2.1.3  | 2.1.0  | 1.0.6   | 1.0.5  | 1.0.4  | 1.0.1  |
...
| **integration-designer**     | **1.6.0**  | 1.5.0  | 1.4.3  | 1.3.9  |          |          |          |        |        |           |            |           |           |           |         |        |        |        |         |        |        |        |
| **application-manager**      | **1.7.1**  | 1.5.6  | 1.4.6  | 1.3.7  | -        | -        | -        | -      | -      | -         | -          | -         | -         | -         | -       | -      | -      | -      | -       | -      | -      |        |
| **data-sync**                | **1.5.0**  | 1.4.0  | 1.3.6  | 1.3.5  | -        | -        | -        | -      | -      | -         | -          | -         | -         | -         | -       | -      | -      | -      | -       | -      | -      |        |
...
| Component        | 4.5.3      | 4.5.2  | 4.5.1 | 4.5.0 | 4.1.4 | 4.1.3 | 4.1.2 | 4.1.1 | 4.1 | 4.0 | 3.4.7 | 3.4.6 | 3.4.5 | 3.4.4 | 3.4.3 | 3.4.2 | 3.4.1 | 3.4.0 | 3.3.0 | 3.2.0 | 3.1.0 | 3.0.0 |
| ---------------- | ---------- | ------ | ----- | ----- | ----- | ----- | ----- | ----- | --- | --- | ----- | ----- | ----- | ----- | ----- | ----- | ----- | ----- | ----- | ----- | ----- | ----- |
| **ai-designer**  | **1.3.4**  | 1.3.2  | 1.0.6 | 1.0.0 | -     | -     | -     | -     | -   | -   | -     | -     | -     | -     | -     | -     | -     | -     | -     | -     | -     |       |
| **ai-assistant** | **1.0.5**  | 1.0.4  | 1.0.2 | 1.0.0 | -     | -     | -     | -     | -   | -   | -     | -     | -     | -     | -     | -     | -     | -     | -     | -     | -     |       |
| **ai-analyst**   | **1.3.6**  | 1.3.5  | 1.2.2 | 1.0.0 | -     | -     | -     | -     | -   | -   | -     | -     | -     | -     | -     | -     | -     | -     | -     | -     | -     |       |
| **di-platform**  | **1.0.20** | 1.0.12 | 1.0.4 | 1.0.0 | -     | -     | -     | -     | -   | -   | -     | -     | -     | -     | -     | -     | -     | -     | -     | -     | -     |       |
| **ai-developer** | **1.0.10** | 1.0.9  | 1.0.7 | 1.0.0 | -     | -     | -     | -     | -   | -   | -     | -     | -     | -     | -     | -     | -     | -     | -     | -     | -     |       |
...
<Check>
**Update default application**: If you have already updated to **v4.5.0** or **v4.5.1**, ensure that you create at least one new version of the default_application(where all the process definitions from previous versions are migrated). This step verifies that your default application remains up to date with the latest changes:
