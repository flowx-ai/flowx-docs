...
<Frame>
  <img src="/images/pdm-overview.png" alt="Project Data Model Overview" />
</Frame>

The Project Data Model (PDM) lets you define reusable data types at the project level. These data types propagate to processes and other resources within your project, ensuring data consistency across your FlowX.AI applications.
...
<Steps>
  ...
  <Step title="Add attributes">
    ...
    - Configure additional properties if needed (e.g., default values, validations)
  </Step>
...
<Steps>
  ...
  <Step title="Make changes">
    Make necessary changes to attributes or properties.
  </Step>
  <Step title="Save changes">
    Save changes.
  </Step>
...
<Accordion title="What happens when I edit a data type?">
...
```json
{
  "error": "Cannot delete data type",
  "message": "The data type 'Customer' is in use by the following processes: 'CustomerOnboarding', 'AccountManagement'",
  "resolution": "Remove all references to this data type before deleting"
}
```
...
2. Add a library as a dependency.
3. Library data types become available in your Project Data Model.
4. These types appear in the side panel but not on the canvas until used.
...
<Frame>
  <img src="/images/pdm-insurance-example.png" alt="Insurance PDM Example" />
</Frame>
...
3. **Policy**
   ...
   - `policyDocuments`: array of Document (reference)
  ...
  <Tab title="Policy Renewal Process">
    ...
    **Data Structure**:
    - **RenewalProcess** (Process-specific type)
      ...
      - `policy`: Policy (reference from PDM)
      - `renewalDate`: date
...
<Tabs>
  <Tab title="Add an attribute">
    <Frame caption="Adding a loyaltyTier attribute to the Customer data type">
      <img src="/images/pdm-add-attribute.png" alt="Adding an attribute" />
    </Frame>
