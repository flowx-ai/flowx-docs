...
FlowX Database supports the following MongoDB operations. Each tab includes practical examples that you can use as a starting point for your own operations.

<Tabs>
  <Tab title="find">
    **Parameters:**
    
    - **filter** (document, optional): Criteria to match documents
    - **sort** (document, optional): Document specifying the sorting order
    - **skip** (integer, optional): Number of documents to skip
    - **limit** (integer, optional): Maximum number of documents to return
    - **projection** (document, optional): Fields to include or exclude
  ...
  <Tab title="findOne">
    **Parameters:**
    ...
    - **filter** (document, optional): Criteria to match the document
    - **projection** (document, optional): Fields to include or exclude
    - **sort** (document, optional): Document specifying the sorting order
  ...
  <Tab title="insertOne">
    **Parameters:**
    ...
    - **document** (document, required): The document to insert
  ...
  <Tab title="updateOne">
    **Parameters:**
    ...
    - **filter** (document, required): Criteria to match the document to update
    - **update** (document, required): Update operations to apply
    - **upsert** (boolean, optional): When true, creates a new document if no documents match the filter
  ...
  <Tab title="updateMany">
    **Parameters:**
    ...
    - **filter** (document, required): Criteria to match documents to update
    - **update** (document, required): Update operations to apply
    - **upsert** (boolean, optional): When true, creates a new document if no documents match the filter
  ...
  <Tab title="deleteOne">
    **Parameters:**
    ...
    - **filter** (document, required): Criteria to match the document to delete
  ...
  <Tab title="deleteMany">
    **Parameters:**
    ...
    - **filter** (document, required): Criteria to match documents to delete
