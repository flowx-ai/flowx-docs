...
<Info>
FlowX Database is powered by the **nosql-db-runner** microservice, which provides pure MongoDB functionality within the FlowX ecosystem. This microservice enables native MongoDB operations while maintaining FlowX's workflow integration capabilities.
</Info>
...
- **Full MongoDB support**: Access to the complete range of MongoDB operations and query capabilities
