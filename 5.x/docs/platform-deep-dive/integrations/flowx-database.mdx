...
For more information about the **nosql-db-runner** service and CosmosDB considerations, see the [nosql-db-runner documentation](/5.x/docs/platform-deep-dive/integrations/nosql-db-runner).
</Info>
