...
<Frame>
![Dependencies overview](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/release50/dependencies_overview.png)
</Frame>
...
<Tabs>
  <Tab title="Project Dependencies">
    **Project Dependencies** allow projects to reference and use resources from libraries.
    ...
    <Frame>
    ![Project dependencies example](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/release50/project_dependencies.png)
    </Frame>
  </Tab>
  ...
  <Tab title="Library Dependencies">
    **Library Dependencies** enable libraries to depend on other libraries, creating hierarchical dependency structures.
    ...
    <Frame>
    ![Library dependencies example](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/release50/library_dependencies.png)
    </Frame>
  </Tab>
</Tabs>
...
```
Mortgage Project
├── Subprocesses Library (1.2.0)
│   └── Enums Library (1.5.0)
└── Integrations Library (2.4.0)
    └── Enums Library (1.5.0)  # ✅ Same version - ALLOWED
```
...
<Steps>
  ...
  <Step title="Add Library Dependency">
    ...
    <Frame>
    ![Add project dependency](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/release50/add_project_dependency.png)
    </Frame>
  </Step>
  ...
  <Step title="Select Build Version">
    ...
    <Warning>
    Always select a **committed build** rather than WIP (Work in Progress) versions for stability.
    </Warning>
  </Step>
...
<Steps>
  ...
  <Step title="Add Library Dependency">
    ...
    <Frame>
    ![Add library dependency](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/release50/add_library_dependency.png)
    </Frame>
  </Step>
  ...
  <Step title="Review Dependency Tree">
    ...
    <Frame>
    ![Library dependency tree](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/release50/library_dependency_tree.png)
    </Frame>
  </Step>
</Steps>
