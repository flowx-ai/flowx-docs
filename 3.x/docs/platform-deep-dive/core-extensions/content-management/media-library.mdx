...
<Tip>
You can also upload an image directly to the Media Library on the spot when configuring a process using the [**UI Designer**](/3.x/docs/building-blocks/ui-designer/ui-designer). More information [**here**](/3.x/docs/building-blocks/ui-designer/ui-component-types/image#media-library).
</Tip>
...
<Tip>
More details on how to configure an image component using UI Designer - [**here**](/3.x/docs/building-blocks/ui-designer/ui-component-types/image).
</Tip>
