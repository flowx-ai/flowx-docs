...
The Font Management screen includes a search functionality that helps you quickly find specific fonts. You can search for fonts using various criteria:
...
The search is performed in real-time as you type, filtering the fonts table to show only the matching results. This makes it easier to manage large collections of fonts.
