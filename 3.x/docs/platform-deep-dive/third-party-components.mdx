...
description: FlowX platform uses a number of third-party software components
icon: cube
---
...
* [Redis](#redis)
* [NGINX](#nginx)
* [EFK (Elastic Search, Fluentd, Kibana)](#efk)
* [S3 (MinIO)](#s3-minio)
...
| ------------------------- | ---------------------------- | ---------------------------- |
| 3.4.x                     | Keycloak                     | 18.x                         |
| 3.4.x                     | Kafka / Zookeeper*           | 3.0.1 / 3.6.3                |
| 3.4.x                     | Jaeger                       | 1.34.1                       |
| 3.4.x                     | AKHQ                         | 0.17.0                       |
| 3.4.x                     | PostgreSQL                   | 14.3.0                       |
| 3.4.x                     | MongoDB                      | 5.0.8                        |
| 3.4.x                     | Redis                        | 6.2.6                        |
| 3.4.x                     | NGINX Ingress Controller     | 1.2.0                        |
| 3.4.x                     | Elasticsearch                | 7.17                         |
| 3.4.x                     | Fluentd                      | 3.3.0                        |
| 3.4.x                     | Kibana                       | 7.17                         |
| 3.4.x                     | S3 (Min.IO) / minio-operator | 2021-02-14T04-01-33Z / 4.5.4 |

### Third-party components supported/tested versions

| FlowX.AI Platform version | Component name | Supported/tested versions |
| ------------------------- | -------------- | ------------------------- |
| 3.4.x                     | OracleDB       | 12C / 18-XE               |
...
#### EFK (Kibana, fluentd, Elastic Search) {#efk}
...
#### Kafka Connect Elasticsearch Service Sink {#kafka-connect-elasticsearch}
