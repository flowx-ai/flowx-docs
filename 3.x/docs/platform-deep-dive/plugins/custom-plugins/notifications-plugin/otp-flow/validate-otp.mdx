---
title: Validate OTP
description: Learn how to validate One-Time Passwords (OTP) using Kafka topics, including request/response formats and implementation steps in FlowX.ai
keywords: [OTP validation, one-time password, Kafka topics, OTP verification, validation flow, SMS verification, email verification]
---

# Validate OTP (One-Time Password)

This guide explains how to validate One-Time Passwords (OTP) using the FlowX.ai platform's notification plugin. Learn about required Kafka topics, request/response formats, and implementation steps for OTP validation in your business flows.
...
![OTP Validation Audit Log](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/platform-deep-dive/otp_validate_audit.png)
...
![OTP Validation Configuration](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/platform-deep-dive/validate_otp_temp.png)
...
![OTP Validation Process Configuration](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/platform-deep-dive/validate_otp3.png)
