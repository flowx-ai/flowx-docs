...
You can quickly find specific out-of-office records using the search functionality:

1. Use the search bar at the top of the out-of-office records list
2. You can search by:
   * User's first name
   * User's last name
   * Username
...
The search results update automatically as you type, showing only the records that match your search criteria.

<Info>
The search is case-insensitive and will match partial text entries. For example, typing "jo" will find users named "John" or "Joseph".
</Info>
