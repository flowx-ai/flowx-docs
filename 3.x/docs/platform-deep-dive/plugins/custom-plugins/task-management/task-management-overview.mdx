...
* **Search**: A powerful search function that allows users to:
  * Search by process keys stored in the process
  * Filter tasks using multiple criteria
  * Use advanced search operators (AND, OR)
  * Search by specific fields like title, assignee, or status
  * Apply date range filters
  * Save frequently used search criteria for quick access

The search functionality supports both basic and advanced search patterns, enabling users to quickly locate specific tasks or groups of tasks based on their requirements.
...
<Info>
Please note that specific roles must be defined in a process to utilize all task management features. For configuration details, see [**Configuring Access Roles for Task Management**](../../../../../setup-guides/plugins-access-rights/configuring-access-rights-for-task-management).
</Info>
...
[Task Management plugin setup](../../../../../setup-guides/plugins-setup-guide/task-management-plugin-setup)
