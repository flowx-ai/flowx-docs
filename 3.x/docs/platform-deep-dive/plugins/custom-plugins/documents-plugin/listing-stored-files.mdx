...
<Check>
  Check out the [**List buckets API reference**](/3.x/docs/api/list-buckets) for more details.
</Check>
...
<Check>
  Check out the [**List objects in a bucket API reference**](/3.x/docs/api/list-objects-in-buckets) for more details.
</Check>
...
<Check>
  Check out the [**Download file API reference**](/3.x/docs/api/download-file.mdx) for more details.
</Check>
