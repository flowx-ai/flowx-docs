...
description: Learn how to add and configure new nodes in your process definition including Start Events, End Events, Service Tasks, User Tasks, Gateways, Message Tasks, and Milestones in the FlowX Designer.
---
