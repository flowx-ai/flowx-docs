...
description: "The core of the platform is the process definition, which is the blueprint of the business process made up of [nodes](../node/node) that are linked by sequences."
---
...
<Card title="Failed process start" href="./3.x/docs/building-blocks/process/process-instance#exceptions" icon="file">
</Card>
</CardGroup>
