---
title: Subprocess
description: Sub-processes are smaller process flows that can be triggered by actions in the main process. Also known as child processes or subprocess workflows, they can inherit process parameter values from the parent process and send their results back to the parent process when completed. The subprocesses will communicate with the front-end apps using the same connection details as their parent process.
---
...
<Card title="Subprocess run node" href="../node/subprocess-run-node" icon ="link">
</Card>
