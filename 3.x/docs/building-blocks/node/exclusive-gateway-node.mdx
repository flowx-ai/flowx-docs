...
* **Language**: When configuring conditions, you can use [MVEL](3.x/3.x/docs/platform-overview/frameworks-and-standards/business-process-industry-standards/intro-to-mvel) (or [DMN](#dmn-example)) expressions that evaluate to either **true** or **false**.
