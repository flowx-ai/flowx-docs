...
description: "Learn about BPMN Timer Events: Timer Start Events, Timer Intermediate Events, and Timer Boundary Events. Discover how to use time-based triggers, scheduling, cron expressions, and time intervals in your business processes. Configure time-based automation with dates, durations, and cycles in BPMN workflows."
---
...
### Activating and Suspending Timers
...
## Timer Event Configuration Options
...
## Additional Timer Event Resources
