...
<Info>
If you are defining this action on a [**subprocess**](../node/subprocess-run-node), you can send the message to the parent process using **Target Process: Parent process**.
</Info>
