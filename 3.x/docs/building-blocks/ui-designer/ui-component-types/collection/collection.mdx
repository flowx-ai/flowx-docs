---
title: Collection
description: The Collection component is similar to a [container element](../root-components/container), allowing you to iterate through a list of elements and display them according to their configuration.
---
...
<Card title= "Collection prototype" href="/3.x/docs/building-blocks/ui-designer/ui-component-types/collection/collection_prototype" icon="link">
</Card>