...
* a [**start**](../../../node/start-end-node#start-node) node and an [**end**](../../../node/start-end-node#end-node) node
* a [**start milestone**](/3.x/docs/building-blocks/node/milestone-node) and an [**end milestone**](/3.x/docs/building-blocks/node/milestone-node) node

![](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/building-blocks/ui-designer/dynamic_dropdown1.gif)

* a [**task node**](../../../node/task-node) (this will be used to set which data will be displayed on the dropdowns)
