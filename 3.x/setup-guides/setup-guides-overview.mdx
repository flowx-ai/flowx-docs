...
1. [**scheduler-core**](../docs/platform-deep-dive/core-extensions/scheduler)
2. [**customer-management-plugin**](../docs/platform-deep-dive/plugins/custom-plugins/customer-management/customer-management-overview)
3. [**document-plugin**](../docs/platform-deep-dive/plugins/custom-plugins/documents-plugin/documents-plugin-overview)
4. [**notification-plugin**](../docs/platform-deep-dive/plugins/custom-plugins/notifications-plugin/notifications-plugin-overview)
5. [**flowx-engine**](../docs/platform-deep-dive/core-components/flowx-engine)
...
<Card title= "Third-party components" href="../docs/platform-deep-dive/third-party-components" icon ="link">
</Card>
