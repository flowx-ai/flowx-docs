...
You can either create or import a user group into a realm. We prepared a [script](../../docs/platform-deep-dive/assets/importUsers.zip) that helps you to import a **super admin group** provided with the necessary **default user roles**.
