...
<Card title="Server admin LDAP" href="https://www.keycloak.org/docs/latest/server_admin/#_ldap" icon="link">
</Card>

Configuration examples:
<CardGroup>
<Card title="Setup user federation LDAP" href="https://documentation.abas.cloud/en/abas-keycloak/setup-user-federation-ldap.html" icon ="link">
</Card>
...
<Card title="Identity broker" href="https://www.keycloak.org/docs/latest/server_admin/#_identity_broker_first_login" icon ="link">
</Card>
