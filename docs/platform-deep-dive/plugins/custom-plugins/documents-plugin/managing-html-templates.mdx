...
Additionally, the platform incorporates a [**What You See Is What You Get (WYSIWYG)**](../../../../wysiwyg.md) editor, allowing users to have a real-time, visual representation of the document or content during the editing process. Furthermore, you have the capability to test and review your template by downloading it as a PDF.
...
<Tip>
Download a PDF sample [**here**](../../../../../assets/726_ManageHTMLTemplate%20.pdf).
</Tip>