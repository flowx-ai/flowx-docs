...
description: You can create and manage notification templates using [**FLOWX.AI Designer**](../../../../../terms/flowx-ai-designer) web app, by accessing the dedicated section.
---
