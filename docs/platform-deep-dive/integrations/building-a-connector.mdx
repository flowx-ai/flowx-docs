---
title:
description: Connectors are the vital gateway to enhancing FLOWX.AI's capabilities. They seamlessly integrate external systems, introducing new functionalities by operating as independently deployable, self-contained microservices.
---
...
<Card title = "Currency Exchange Example Connector" href = "https://github.com/flowx-ai/quickstart-connector/tree/example/currency-exchange">
</Card>