---
title: Access rights for Integration management
description: Granular access rights can be configured for restricting access to the Integration Management plugin component. These access rights must be configured in the Designer (admin) deployment.
---
...
<Warning>
These roles need to be defined in the chosen identity provider solution. It can be either kyecloak, RH-SSO, or another identity provider solution. For more details on how to define service accounts, check the [Access rights](../../../../setup-guides/access-management/configuring-an-iam-solution) section.
</Warning>
