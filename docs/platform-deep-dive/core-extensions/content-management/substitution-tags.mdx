...
description: Substitution tags are used to generate dynamic content across the platform. As [**enumerations**](../../../../terms/flowx-enumerations), substitution tags can be defined for each language set for the solution.
---
