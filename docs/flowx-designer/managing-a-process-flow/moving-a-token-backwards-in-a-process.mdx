...
description: Back in process is a functionality that allows you to go back in a business process redo a series of previous [**actions**](../../terms/flowx-actions) in the process.
---
