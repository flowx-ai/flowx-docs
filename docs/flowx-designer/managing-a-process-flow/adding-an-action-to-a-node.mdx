...
description: We use actions to add business decisions to the [**flow**](../../terms/flowx-process) or link the process to custom integrations and [**plugins**](../../terms/flowx-plugins).
---
