...
To easily design and model process flows, we use the standard [**BPMN 2.0**](../../../terms/bpmn) graphical representation.
...
<Card title = "BPMN Quick guide" icon="link" href="https://www.bpmnquickguide.com/view-bpmn-quick-guide/"></Card>

<Card title = "BPMN Best practices" icon="link" href="https://bpmtips.com/interview-with-sandeep-johal-process-modeling-best-practices/"></Card>
