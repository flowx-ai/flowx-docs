---
title: "Intro to Kafka concepts"
description: "Apache Kafka is an open-source distributed event streaming platform that can handle a high volume of data and enables you to pass messages from one end-point to another."
---
...
## In-depth docs
<CardGroup>
<Card icon = "link" title ="Kafka documentation" href = "https://kafka.apache.org/intro"></Card>
