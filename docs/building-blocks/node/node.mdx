...
+ **Milestones** - Start and end nodes for milestones are used to define [UI components](../ui-designer/ui-designer) such as steppers on a page.
...
[Managing a process flow](../../flowx-designer/managing-a-process-flow/managing-a-process-flow)