---
title: "Task node"
description: "A task [**node**](../../terms/flowx-node) refers to a task that utilizes various services, such as Web services, automated applications, or other similar services, to accomplish a particular task."
---
