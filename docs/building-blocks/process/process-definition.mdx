...
<CardGroup>
<Card title="Process instance" href="./active-process/process-instance" icon="file">
</Card>

<Card title="Failed process start" href="./active-process/failed-process-start" icon="file">
</Card>
</CardGroup>
...
<Card title ="Audit" href="../../platform-deep-dive/core-components/core-extensions/audit">
</Card>
...
<Card title ="Configuring access roles for processes" href="../../platform-setup-guides/flowx-engine-setup-guide/configuring-access-roles-for-processes" icon="file">
</Card>
...
<Card title="Configuring access rights for processes" href="../../platform-setup-guides/flowx-engine-setup-guide/configuring-access-roles-for-processes">
</Card>
