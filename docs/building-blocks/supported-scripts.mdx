...
icon: file-code
description: "Scripts are used to define and run [actions](./actions/actions.md) but also properties inside [nodes](./node/node.md). For now, the following script languages are supported."
---
...
<Card title ="DMN Business rule action" href= "/docs/building-blocks/actions/business-rule-action/dmn-business-rule-action"></Card>
