...
description: An **Upload File action** is an [**action**](../../terms/flowx-actions) type that allows you to upload a file to a service available on [**Kafka**](../../terms/flowx-kafka).
---
