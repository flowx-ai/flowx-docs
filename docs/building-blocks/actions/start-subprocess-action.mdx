...
description: A **Start subprocess action** is an [**action**](../../terms/flowx-actions) that allows you to start a [**subprocess**](../../terms/flowx-subprocess) from another (parent) [**process**](../../terms/flowx-process).
---
