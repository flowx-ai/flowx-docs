---
title: Append params to parent process
description: It is a type of [**action**](../../terms/flowx-actions) that allows you to send data from a [subprocess](../process/subprocess.md) to a parent [process](../process/process.md).
---
