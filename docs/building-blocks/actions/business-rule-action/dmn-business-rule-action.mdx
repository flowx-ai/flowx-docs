...
description: If you're new to the concept of [**Decision Model and Notation (DMN)**](../../../terms/dmn), you can get started with a brief overview in the [Intro to DMN](../../../platform-overview/frameworks-and-standards/business-process-industry-standards/intro-to-dmn.md) section.
---
