...
description: If you're new to the concept of <Tooltip tip ="DMN stands for Decision Model and Notation. It is a graphical language used to specify business decisions. DMN helps convert complex decision-making code into easily readable diagrams."> **Decision Model and Notation (DMN)** </Tooltip>, you can get started with a brief overview in the [Intro to DMN](../../../platform-overview/frameworks-and-standards/business-process-industry-standards/intro-to-dmn) section.
---
