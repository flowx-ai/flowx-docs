---
title: Buttons
description: There are two types of buttons available, each with a different purpose.
---
...
<CardGroup>
<Card title = "Basic button" icon = "hand-pointer" href= "#basic-button"> </Card>
<Card title = "File upload button" icon="file-arrow-up" href= "#file-upload"></Card>
</CardGroup>
