---
title: Collection
description: The Collection component is similar to a [Container element](../root-components/custom.md), allowing you to iterate through a list of elements and display them according to their configuration.
---
