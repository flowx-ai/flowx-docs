...
<Check>
UI Actions and [Actions](../actions/actions.md) must be configured on the same node.
</Check>
...
<Info>
Not available for UI actions on [Custom components](./ui-component-types/root-components/custom.md).
</Info>
