...
<Card title="Integration Designer" href="../platform-deep-dive/core-extensions/integration-designer" icon ="ruler-combined">
</Card>
...
<Card title="SDKs" href="../sdks" icon ="browser">
</Card>
