...
| ---------------------------------- | -------------------------- | ----------------------------------- |
| `SECURITY_OAUTH2_BASE_SERVER_URL`  | Base URL for OAuth2 server | `https://keycloak.example.com/auth` |
| `SECURITY_OAUTH2_CLIENT_CLIENT_ID` | OAuth2 client ID           | `data-search-service`               |
