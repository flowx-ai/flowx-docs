...
### Skipping plugins for data-sync

If your deployment doesn't have certain plugins installed, you should configure data-sync to skip migrations for those plugins:
...
This prevents data-sync from failing when trying to synchronize databases for plugins that aren't installed in your environment.
