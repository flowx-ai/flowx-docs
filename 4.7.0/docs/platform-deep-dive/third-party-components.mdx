...
| FlowX.AI Version | 3rd Party Dependency     | Minimum Supported Version | Recommended Supported Version |
| ---------------- | ------------------------ | ------------------------- | ----------------------------- |
| 4.7.0            | Keycloak                 | 22.x                      | 26.x                          |
| 4.7.0            | Kafka                    | 3.2.x                     | 3.2.x                         |
| 4.7.0            | PostgreSQL               | 16.2.x                    | 16.2.x                        |
| 4.7.0            | MongoDB                  | 7.0.x                     | 7.0.x                         |
| 4.7.0            | Redis                    | 7.2.x                     | 7.2.x                         |
| 4.7.0            | NGINX Ingress Controller | 1.2.x                     | 1.2.x                         |
| 4.7.0            | Elasticsearch            | 7.17.x                    | 7.17.x                        |
| 4.7.0            | minio                    | 2024-02-26T09-33-48Z      | 2024-02-26T09-33-48Z          |


### Third-party components supported/tested versions

| FlowX.AI Version | 3rd Party Dependency | Minimum Supported Version | Supported/tested versions |
| ---------------- | -------------------- | ------------------------- | ------------------------- |
