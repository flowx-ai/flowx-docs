...
| ------------------ | ---------------- | ---------------------------------------- | ------------------------ |
| Python             | 2.7.0            | org.python » jython-standalone           | 2.7.4                    |
...
| JavaScript         | ECMAScript 5.1   | org.openjdk.nashorn » nashorn-core               | 15.4                     |
...
| JavaScript         | ES 2019+         | GraalJS          | GraalVM 24.1.2           |
