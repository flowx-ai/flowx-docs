---
title: Admin
description: The admin part manages process-related entities and provides the REST API used by the **FlowX Designer**. The processes defined here will be handled by the [**FlowX Engine**](../docs/platform-deep-dive/core-components/flowx-engine).
icon: terminal
---
