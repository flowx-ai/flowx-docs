...
<div className="mb-20">
  <Tabs>
    <Tab title="Architecture">
      <div className="p-8 md:p-10 bg-white/90 dark:bg-gray-900/90 backdrop-blur-sm">
          <div>
...
<div className="mt-28 mb-20">
  ...
  <Steps>
    <Step title="Quickstart" icon="bolt" iconType="solid" iconColor="#fdb913">
      <div className="p-5 my-2 bg-white/90 dark:bg-gray-800/90 rounded-lg border border-gray-100 dark:border-gray-700 hover:border-[#fdb913] dark:hover:border-[#fdb913] transition-colors duration-300 backdrop-blur-sm shadow-sm hover:shadow-md">
