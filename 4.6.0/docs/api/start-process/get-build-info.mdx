...
description: This endpoint retrieves information about the build of a specific project, as set by the Active policy.
---
...
<RequestExample> 
```bash
curl -X GET "{baseUrl}/api/runtime/app/{appId}/build/info" \
